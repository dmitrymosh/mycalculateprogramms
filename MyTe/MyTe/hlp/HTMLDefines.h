...
#define HID_ACTION_OPTION                       0x18003
#define HID_ACTION_OPTION32772                  0x18004
#define HID_ACTION_OPTION1                      0x18005
#define HID_ACTION_32774                        0x18006
#define HID_ACTION_TEST                         0x18007
#define HID_ACTION_CALCULATE                    0x18008
#define HID_ACTION_CALCULATE32777               0x18009
#define HID_ACTION_CALCULATE2                   0x1800A
#define HID_ACTION_TEST2                        0x1800B
#define HID_ACTION_32780                        0x1800C
#define HID_ACTION_32781                        0x1800D
#define HID_ENERGY_DISTR                        0x1800E
#define HID_MAGNITUDE                           0x1800F
#define HID_MAGNITUDE1                          0x18010
#define HID_ENERGY_DISTR1                       0x18011
#define HID_ACTION_ANY                          0x18012
#define HID_ACTION_ANY1                         0x18013
#define HID_POP_1                               0x18014
#define HID_POP_2                               0x18015
#define HID_POP_3                               0x18016
#define HID_POP_4                               0x18017
#define HID_POP_5                               0x18018
#define HID_POP_6                               0x18019
#define HID_POP_7                               0x1801A
#define HID_POP_8                               0x1801B
#define HID_POP_9                               0x1801C
#define HID_POP_0                               0x1801D
#define HID_POP_10                              0x1801E
#define HID_POP_11                              0x1801F
#define HID_POP_12                              0x18020
#define HID_POP_32801                           0x18021
#define HID_POP_UP                              0x18022
#define HID_POP_MUX                             0x18023
#define HID_FILE_SAVEDATA                       0x18024
#define HID_POP_32805                           0x18025
#define HID_FUNCT                               0x18026
#define HID_Menu                                0x18027
#define HID_32808                               0x18028
#define HID_32809                               0x18029
#define HID_FUNC_MAGN                           0x1802A
#define HID_FUNC_ENERGY                         0x1802B
#define HID_FUNC_COUNT                          0x1802C
#define HID_POP_13                              0x1802D
#define HID_1_1                                 0x1802E
#define HID_1_2                                 0x1802F
#define HID_1_3                                 0x18030
#define HID_1_4                                 0x18031
#define HID_1_5                                 0x18032
#define HID_1_6                                 0x18033
#define HID_1_7                                 0x18034
#define HID_1_8                                 0x18035
#define HID_1_9                                 0x18036
#define HID_1_0                                 0x18037
#define HID_1_11                                0x18038
#define HID_1_12                                0x18039
#define HID_1_13                                0x1803A
#define HID_1_14                                0x1803B
#define HID_1_15                                0x1803C
#define HID_1_16                                0x1803D
#define HID_1_17                                0x1803E
#define HID_1_18                                0x1803F
#define HID_1_19                                0x18040
#define HID_1_20                                0x18041
#define HID_1_21                                0x18042
#define HID_1_22                                0x18043
#define HID_1_23                                0x18044
#define HID_1_24                                0x18045
#define HID_1_25                                0x18046
#define HID_1_26                                0x18047
#define HID_1_27                                0x18048
#define HID_1_28                                0x18049
#define HID_1_29                                0x1804A
#define HID_1_30                                0x1804B
#define HID_1_31                                0x1804C
#define HID_1_32                                0x1804D
#define HID_1_33                                0x1804E
#define HID_1_34                                0x1804F
#define HID_1_35                                0x18050
#define HID_1_36                                0x18051
#define HID_1_37                                0x18052
#define HID_1_38                                0x18053
#define HID_1_39                                0x18054
#define HID_1_40                                0x18055
#define HID_POP_FOT                             0x18056
#define HID_POP_32855                           0x18057
#define HID_SAVE_ENERGY_COUNT                   0x18058
#define HID_POP_32857                           0x18059
#define HID_POP_RESPONCE                        0x1805A
#define HID_32859                               0x1805B
#define HID_FUNC_                               0x1805C
#define HID_FUNC_RESPONCE                       0x1805D
#define HID_32862                               0x1805E
#define HID_NORM_5500                           0x1805F
#define HID_FUNC_NORM_5500                      0x18060
#define HID_ACTION_32865                        0x18061
#define HID_ACTION_NORM5500                     0x18062
#define HID_ACTION_32867                        0x18063
#define HID_ACTION_NORM55001                    0x18064
#define HID_ACTION_32869                        0x18065
#define HID_ACTION_32870                        0x18066
#define HID_ACTION_BANDS                        0x18067
#define HID_ACTION_TEST32872                    0x18068
#define HID_ACTION_AID                          0x18069
#define HID_ACTION_AID32874                     0x1806A
#define HID_ACTION_AID1                         0x1806B
#define HID_ACTION_32876                        0x1806C
#define HID_ACTION_32877                        0x1806D
#define HID_ACTION_32878                        0x1806E
#define HID_CONVERT_MT                          0x1806F
#define HID_CONVERT_M                           0x18070
#define HID_VIEW_VIEWDATA                       0x18071
#define HID_ACTION_VIEWDATA                     0x18072
#define HID_ACTION_32883                        0x18073
#define HID_ACTION_MINUS_REMOVE                 0x18074
#define HID_ACTION_32885                        0x18075
#define HID_ACTION_REMOVE_MINUS_MANY            0x18076
#define HID_VIEW_VIEWRESULT                     0x18077
#define HID_ACTION_GGGDFGH                      0x18078
#define HID_GGGDFGH_1                           0x18079
#define HID_GGGDFGH_2                           0x1807A
#define HID_GGGDFGH_3                           0x1807B
#define HID_Menu32892                           0x1807C
#define HID_ACTION_TESTING                      0x1807D
...
#define HIDR_MyTeTYPE                           0x20081
#define HIDR_MENU1                              0x20088
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_OPTION_DIALOG                      0x20082
#define HIDD_MULTI_FLUX_DIALOG                  0x20084
#define HIDD_OPTION_PAGE1                       0x2008A
#define HIDD_OPTION_PAGE2                       0x2008E
#define HIDD_OPTION_PAGE3                       0x2008F
#define HIDD_RESP_SELECT_DLG                    0x20090
#define HIDD_ROW_TO_COL                         0x20091
#define HIDD_VIEW_DATA_DLG                      0x20092
